...
class WandbLogger():
    """Log training runs, datasets, weights, and predictions to Weights & Biases.
    ...
    weights and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO weights:
