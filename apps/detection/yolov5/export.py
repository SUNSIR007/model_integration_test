...
def run(
    ...
    if any((saved_model, pb, tflite, edgetpu, tfjs)):  # TensorFlow formats
        assert not tflite or not tfjs, 'TFLite and TF.js weights must be exported separately, please pass only one type.'
    ...
    if any(f):
        ...
        det &= not seg  # segmentation weights inherit from SegmentationModel(DetectionModel)
